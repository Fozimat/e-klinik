...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            @endif
            <a href="{{ route('patients.create') }}" class="btn btn-primary waves-effect waves-light mb-3"> <i
                    class="uil uil-plus-circle me-2"></i>Tambah Pasien</a>
